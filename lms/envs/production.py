...
BADGR_USERNAME = AUTH_TOKENS['BADGR_USERNAME']
BADGR_PASSWORD = AUTH_TOKENS['BADGR_PASSWORD']
BADGR_TOKENS_CACHE_KEY = AUTH_TOKENS['BADGR_TOKENS_CACHE_KEY']
BADGR_BASE_URL = AUTH_TOKENS['BADGR_BASE_URL']
BADGR_ISSUER_SLUG = AUTH_TOKENS['BADGR_ISSUER_SLUG']
BADGR_ENABLE_NOTIFICATIONS = AUTH_TOKENS['BADGR_ENABLE_NOTIFICATIONS']
BADGR_TIMEOUT = AUTH_TOKENS['BADGR_TIMEOUT']